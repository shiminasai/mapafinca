...
urlpatterns = [
    ...
    url(r'^dashboard-principal/$', views.principal_dashboard, name='dashboard'),
    #url(r'^dashboard-principal-pais/(?P<pais>[-_\w]+)/$', views.principal_dashboard_pais, name='dashboard'),
